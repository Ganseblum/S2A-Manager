    ...
    .query(async ({ ctx }) => {
          ...
          where: {
            key: {
              in: [
                ...
                "account_balance_alert_last_run_at",
                "account_balance_alert_next_run_at",
      ...
      return {
        ...
        worker: {
          ...
          intervalSeconds,
          accountBalanceAlertIntervalSeconds: runtimeSettings.accountBalanceAlertIntervalSeconds,
          accountBalanceAlertLastRunAt: parseDate(settingMap.get("account_balance_alert_last_run_at")),
          accountBalanceAlertNextRunAt: parseDate(settingMap.get("account_balance_alert_next_run_at")),
